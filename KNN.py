...
while not (choice=="Yes" or choice=="No"):
    choice=input("Error input, Input agian [Yes(Automatic calculation) or No(user input)]: ")
if choice == "Yes":
#all parameter
...
#UI
    ...
    while is_continue=="y":
        ...
        #calculate accuracy
        accuracy=ten_cross_validation(int(k),weighted,mtx,label_list,int(parameter))
